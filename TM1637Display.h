...
public:
  ...
  //! data pins.
  //!
  //! @param pinClk - The number of the digital pin connected to the clock pin
  //! of the module
  //! @param pinDIO - The number of the digital pin connected to the DIO pin of
  //! the module
  ...
  //! segment data
  //! is given as a byte array, each byte corresponding to a single digit.
  //! Within each byte,
  //! bit 0 is segment A, bit 1 is segment B etc.
  //! The function may either set the entire display or any desirable part on
  //! its own. The first
  //! digit is given by the @ref pos argument with 0 being the leftmost digit.
  //! The @ref length
  ...
  //! @param pos The position from which to start the modification (0 -
  ...
  //! number to be shown
  //!        fits to the number of digits requested (for example, if two digits
  //!        are to be displayed,
  //!        the number must be between 0 to 99)
  //! @param pos The position most significant digit (0 - leftmost, 3 -
  //! rightmost)
  ...
  //!
  //! Dispalyes the given argument as a decimal number. The dots between the
  //! digits (or colon)
  ...
  //!        are to be displayed,
  //!        the number must be between 0 to 99)
  //! @param pos The position least significant digit (0 - leftmost, 3 -
  //! rightmost)
  ...
  //! @return A code representing the 7 segment image of the digit (LSB -
  //! segment A;
